...
### *v* = (1, 1, 1 − *s*) nomes tenim seleccio contra un dels homozigots (el que
### te 1-s)
...
### en poblacio molt gran tot i que alel sigui moolt beneficios, com que deriva
## no esta podent actuar amb força es molt dificil que s'arribi a fixar
